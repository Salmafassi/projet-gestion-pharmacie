...
<div class="right_col" role="main">
  ...
  <div class="row">
    ...
    <div class="panel  " style="margin-top:60px;height:400px;width:700px;">
        <div class="panel-heading"  style="background-color:#00d4ff;">veuillez saisir les donnees de nouveau fournisseur</div>
        <div class="panel-body">
        <form action="insertfournisseur.php"  method="post">
              <div class="form-group ">
                  <label for="nom">nom:</label>
                   <input type="text" name="name" class="form-control " placeholder="tapez le nom de fournisseur" style="height:40px;font-size:13px" > 
                </div>
