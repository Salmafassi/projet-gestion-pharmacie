...
$requete="select  id_stocké,libellé,date_experation,QT_stocké,date,nom_depot,ville,prixvente,stockmini from depot as d, medicament as m, medica_stocké as ms where ( d.N_depot=ms.ndepot and m.code=ms.code_medica)  and (d.nom_depot like '$nomdepot%' )and (m.libellé like '%$libelle%')   limit $size offset $offeset";
$requete1="select  id_stocké,libellé,date_experation,QT_stocké,date,nom_depot,ville,prixvente,stockmini from depot as d, medicament as m, medica_stocké as ms where ( d.N_depot=ms.ndepot and m.code=ms.code_medica)  and (d.nom_depot like '$nomdepot%' )and (m.libellé like '%$libelle%')   ";
...
?>
   ...
   <div class="row"> 
    ...
    <div class="panel  panel-fluid" style="margin-top:60px">
        <div class="panel-heading"  style="background-color:#00d4ff;">Liste des médicaments stockées (<?= $nbrstock; ?> éléments stockés)</div>
        <div class="panel-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($ligne['QT_stocké']==0){
                            ...
                            if($ligne['QT_stocké']>$ligne['stockmini']){
                                $color="green"; 
                            }
                            else{
                                $color="yellow";
